...
import { CreateTravelPlaceSchema } from "../schemas/travel-place";
...
import { CreateTravelPlaceDto } from "../dtos/travel-place";
...
export const updateTravelPlace = async (req: Request, res: Response) => {
    res.send('update travel place called');
}

export const deleteTravelPlace = async (req: Request, res: Response) => {
    res.send('delete travel place called');
}